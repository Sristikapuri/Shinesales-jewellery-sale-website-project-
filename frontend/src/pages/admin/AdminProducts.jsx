...
const AdminProducts = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#b8860b] to-white flex items-center justify-center">
        <div className="text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f3f6f4] to-white">
      {/* Header */}
      <section className="bg-gradient-to-r from-[#070707] to-[#070707] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="bg-[#b8860b] p-3 rounded-full">
                <Package className="h-8 w-8 text-[#f3f6f4]" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white">Product Management</h1>
                <p className="text-[#b8860b]">Manage your product catalog and inventory</p>
              </div>
            </div>
            ...
            <button 
              ...
              className="bg-[#b8860b] text-[#0A400C] px-6 py-3 rounded-xl font-semibold hover:bg-white transition-colors flex items-center space-x-2"
            >
            ...
            <div className="bg-white rounded-2xl shadow-lg border-2 border-[#B0DB9C]/20 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#f3f6f4]">
                    <tr>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Product</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Category</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Price</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Stock</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Status</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-[#b8860b]">Actions</th>
                    </tr>
                  </thead>
            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
              <div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <button
                    onClick={addImageUrl}
                    className="text-[#eeeeee] bg-[#b8860b] hover:bg-[#806116] rounded-lg px-4 py-2 font-semibold transition-colors"
                    type="button"
                  >
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex justify-end space-x-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2 bg-[#b8860b] text-[#eeeeeee] rounded-lg font-semibold hover:bg-[#806116] transition-colors disabled:opacity-50"
                >
